...
The code found in this GitHub repo contains everything required to download, process, and visualise the global occurrence of MHWs. The MHWs are visualised through an interactive leaflet map that uses a Shiny interface. All of this is done exclusively through the R programming language.
