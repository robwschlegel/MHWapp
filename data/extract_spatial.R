...
ggplot() +
  ...
  geom_spatraster(data = MHW_CIESM_raster, na.rm = TRUE, show.legend = FALSE) +
  geom_sf(data = worldmap, fill = "black", colour = "black") +
  ...
  coord_sf(crs = "+proj=ortho +lat_0=52 +lon_0=10 +x_0=4321000 +y_0=3210000 +ellps=GRS80 +units=m +no_defs",
           xlim = c(100000, 10000000), ylim = c(0, 4000000), expand = FALSE) +
...
ggsave("MHW_CIESM.png", width = 12, height = 6, dpi = 300)
